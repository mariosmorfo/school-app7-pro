...
public class TeacherServiceImpl implements ITeacherService {
    ...
    @Override
    public TeacherReadOnlyDTO updateTeacher(Integer id, TeacherUpdateDTO dto) throws TeacherDAOException, TeacherNotFoundException, TeacherAlreadyExistsException {
        Teacher teacher;
